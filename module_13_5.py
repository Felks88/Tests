...
async def start(message):
    await message.answer('Привет! Я бот помогающий твоему здоровью. Введите Calories для расчёта каллорий.', reply_markup=kb)
...
async def send_calories(message, state):
    ...
    await message.answer(f'Ваши каллории в сутки:'
